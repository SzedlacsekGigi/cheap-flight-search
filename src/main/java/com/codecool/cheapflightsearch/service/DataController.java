...
public class DataController {
    ...
    ArrayList<LinkedHashMap<String, String>> listOfFlightResult = new ArrayList<>();


    public void createMapFromData(ResponseEntity<FlightData> response) {
        for (int i = 0; i < response.getBody().getData().size(); i++) {
            LinkedHashMap<String, String> flightResult = new LinkedHashMap<>();
    ...
    public ArrayList<LinkedHashMap<String, String>> getListOfFlightResult() {
